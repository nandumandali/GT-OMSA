...
tut += chosenVars['Roasted Chicken'] + chosenVars['Pizza W/Pepperoni'] + chosenVars['Scrambled Eggs'] + chosenVars['Hamburger W/Toppings'] + chosenVars['Hotdog, Plain'] + chosenVars['Pork'] + chosenVars['White Tuna in Water'] + chosenVars['Splt Pea&Hamsoup'] + chosenVars['Vegetbeef Soup'] + chosenVars['Neweng Clamchwd'] >= 3, 'Atleast 3 meat'
...
for v in tut.variables():
	if v.varValue > 0 :
		if v.varValue ==1:
			print(str(v.varValue)+ " units of "+str(v).replace('Chosen_',''))
		else:
